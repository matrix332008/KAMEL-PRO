  ...
  _openSeries(dynamic serie) async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (_) => EpisodesScreen(
          name: serie['name'],
          cover: serie['cover'],
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('SERIES', style: TextStyle(color: Colors.orange, fontSize: 28, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                Expanded(
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: active ? Colors.orange.withOpacity(0.3) : null,
                                  border: Border(left: BorderSide(color: active ? Colors.orange : Colors.transparent, width: 4)),
                                ),
                                child: Text(c['category_name'], style: TextStyle(color: active ? Colors.orange : Colors.white)),
                              ),
                            );
                          },
                        ),
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: s['cover'] != null
                                            ? Image.network(s['cover'], fit: BoxFit.cover, width: double.infinity, errorBuilder: (_, __, ___) => Icon(Icons.tv, size: 50, color: Colors.white30))
                                            : Icon(Icons.tv, size: 50, color: Colors.white30),
                                      ),
                                    ),
                                  ),
                                  SizedBox(height: 6),
                                  Text(s['name'] ?? '', maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.white, fontSize: 12), textAlign: TextAlign.center),
                                ],
                              ),
                            );
                          },
